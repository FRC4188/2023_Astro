...
public class Module {
    ...
    private PIDController anglePID = new PIDController(Constants.drivetrain.anglemotor.kP, Constants.drivetrain.anglemotor.kI, Constants.drivetrain.anglemotor.kD);
    ...
    public Module(int angleID, int speedID, int encoderID, double encoderZero) {
        ...
        speedMotor.config_kP(0, Constants.drivetrain.speedmotor.kP, 10);
        speedMotor.config_kI(0, Constants.drivetrain.speedmotor.kI, 10);
        speedMotor.config_kD(0, Constants.drivetrain.speedmotor.kD, 10);
    ...
    return ((double) speedMotor.getSelectedSensorVelocity() * 10.0) / Constants.drivetrain.DRIVE_COUNTS_PER_METER;
    }
    ...
    public void setModuleState(SwerveModuleState state) {
        ...
        speedMotor.set(ControlMode.Velocity, velMultiplier * (state.speedMetersPerSecond * (Constants.drivetrain.DRIVE_COUNTS_PER_METER / 10.0)));
