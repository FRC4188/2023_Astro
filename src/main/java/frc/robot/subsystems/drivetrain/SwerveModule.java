...
public class SwerveModule {
    ...
    public double getCurrentDrawAmps() {
        return inputs.driveStatorCurrentAmps + inputs.driveStatorCurrentAmps;
    }
    ...
    public static class Builder {
        /**
         * Make a SwerveX {@link SwerveModule} with 2 Falcon500s ({@link TalonFX}s) for the drive and turn motors
         ...
         */
        public static SwerveModule SwerveXFalcon500CANCoder(
                final String name,
