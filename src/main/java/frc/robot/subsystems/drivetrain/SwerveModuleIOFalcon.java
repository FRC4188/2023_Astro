...
public class SwerveModuleIOFalcon implements SwerveModuleIO {
    ...
    public void config() {
        ...
        //TODO pls dont have 500,000 different pids for the modules they should all be the same....

        //TODO TUNE PID
        driveTalonFXConfiguration.Slot0 = new Slot0Configs()
                .withKP(50)
                .withKS(5.875);
        driveTalonFXConfiguration.CurrentLimits.StatorCurrentLimit = 50;
        driveTalonFXConfiguration.CurrentLimits.StatorCurrentLimitEnable = true;
        driveTalonFXConfiguration.ClosedLoopRamps.VoltageClosedLoopRampPeriod = 0.15;
