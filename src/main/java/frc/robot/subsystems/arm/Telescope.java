...
public class Telescope {
    ...
    public void init(){
        ...
        liftMotor.setSoftLimit(SoftLimitDirection.kForward, (float) Constants.arm.telescope.UPPER_LIMIT);
        liftMotor.setSoftLimit(SoftLimitDirection.kReverse, (float) Constants.arm.telescope.LOWER_LIMIT);
        liftMotor.setPIDF(Constants.arm.telescope.kP, Constants.arm.telescope.kI, Constants.arm.telescope.kD, Constants.arm.telescope.kF);
