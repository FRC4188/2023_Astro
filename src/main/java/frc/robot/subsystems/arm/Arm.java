...
public class Arm extends SubsystemBase {
  ...
  public Pose2d getPosition()   {
    ...
    double x = elevatorLength * Math.sin(shoulderAngle)+ Constants.claw.TOTAL_DISTANCE * Math.sin(shoulderAngle - wristAngle);
    double z = elevatorLength * Math.cos(shoulderAngle)+ Constants.claw.TOTAL_DISTANCE * Math.cos(shoulderAngle - wristAngle);
