...
public class Limelights {
    ...
    public Pose3d getPose3d() {
        if (LimelightHelpers.getTV(frontLLName)) {
            return (DriverStation.getAlliance() == Alliance.Red) ? LimelightHelpers.getBotPose3d_wpiRed(frontLLName) : LimelightHelpers.getBotPose3d_wpiBlue(frontLLName);
        } else if (LimelightHelpers.getTV(backLLName)) {
            return (DriverStation.getAlliance() == Alliance.Red) ? LimelightHelpers.getBotPose3d_wpiRed(backLLName) : LimelightHelpers.getBotPose3d_wpiBlue(backLLName);
