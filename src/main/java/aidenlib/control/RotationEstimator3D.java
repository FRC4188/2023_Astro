package aidenlib.control;

import java.util.LinkedList;
import java.util.List;

import aidenlib.Timer;
import aidenlib.math.Data;
import aidenlib.math.Derivative;
import aidenlib.math.Integral;
import aidenlib.math.WeightedFusion;
